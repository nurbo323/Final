// ============================================
// GAMEWORLD - FINAL VERSION WITH CORRECT API
// Team NOVA | SE-2406
// ============================================

$(document).ready(function() {
  console.log("✅ jQuery is ready!");
  console.log("🎮 GameWorld Final Version loaded!");
...
// ============================================
// API WITH CORRECT GAMES (NAMES MATCH IMAGES)
// ============================================
function loadGamesFromAPI() {
  const apiUrl = 'https://www.freetogame.com/api/games';
  
  $('#apiGamesLoader').show();
  console.log('🎮 Loading games from Free-to-Game API...');
  ...
  fetch(apiUrl)
    ...
    .then(data => {
      ...
      // КОНКРЕТНЫЕ ИГРЫ которые точно есть в API (по названиям)
      const targetGames = [
        'Overwatch 2',
        'Crossout',
        'Genshin Impact',
      ...
      // Ищем каждую игру по названию
      targetGames.forEach(gameName => {
        const found = data.find(game => 
      ...
      // Если не нашли все 6, берем первые доступные
      if (topGames.length < 6) {
        console.log('⚠️ Some games not found, using first 6 available');
        topGames = data.slice(0, 6);
      }
      
      console.log('✅ Displaying', topGames.length, 'games');
      displayGamesWithRatings(topGames);
      $('#apiGamesLoader').hide();
      showToast(`${topGames.length} games loaded!`, 'success');
    })
    .catch(error => {
      console.log('⚠️ API failed:', error);
      console.log('📦 Using fallback data with correct images...');
      
      // FALLBACK с ПРАВИЛЬНЫМИ картинками
      const fallbackGames = [
        {
          title: "Overwatch 2",
          thumbnail: "https://www.freetogame.com/g/540/thumbnail.jpg",
          short_description: "Team-based multiplayer first-person shooter by Blizzard Entertainment.",
          genre: "Shooter",
          platform: "PC (Windows)",
        ...
        },
        {
          ...
          short_description: "Vehicular combat game with crafting and customization.",
          genre: "Shooter",
          platform: "PC (Windows)",
        ...
        },
        {
          ...
          short_description: "Squad-based World War 2 first-person shooter.",
          genre: "Shooter",
          platform: "PC (Windows)",
        ...
        },
        {
          ...
          short_description: "Strategy game - build your empire through the ages.",
          genre: "Strategy",
          platform: "PC (Windows)",
      ...
      <div class="col-md-4 col-sm-6 mb-4">
        <div class="card bg-dark text-light h-100 border border-info shadow api-game-card">
          <img src="${game.thumbnail}" class="card-img-top" alt="${game.title}" 
               ...
               onerror="this.src='https://via.placeholder.com/400x200/0d0d12/00fff7?text=Game+Image'">
...
console.log("🎮 GameWorld: All features loaded!");
console.log("✅ API, Auth, Theme, Ratings - READY!");
